...
def GPT4oPromptGenerate(system_prompt, user_prompt):
    completion = client.chat.completions.create(model="deepseek-v3-250324", messages=[
...
with open(r"C:\Users\24033\PycharmProjects\ArticleClassification\Data\Summary_insight\key_dict.json", 'r', encoding='utf-8') as f:
    class_description = json.load(f)


with open(r"C:\Users\24033\PycharmProjects\ArticleClassification\Data\Summary_insight\Summary_insight.json", 'r', encoding='utf-8') as f:
    data = json.load(f)

    for review_paper_name in data.keys():
        # if review_paper_name in ['Review1','Review10','Review11','Review12']:
        #     continue
        ...
        # 存储结果
        output_file = fr"C:\Users\24033\PycharmProjects\ArticleClassification\Results\Deepseek\key-insights-direction/{review_paper_name}.pkl"
