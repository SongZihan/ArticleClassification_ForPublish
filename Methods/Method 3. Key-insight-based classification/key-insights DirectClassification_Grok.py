...
with open(r"C:\Users\Administrator\PythonProjects\ArticleClassification\Data\Summary_insight\Summary_insight.json", 'r', encoding='utf-8') as f:
    ...
    for review_paper_name in data.keys():
        if review_paper_name in ['Review1','Review10']:
            continue
        ...
        # 存储结果
        output_file = fr"C:\Users\Administrator\PythonProjects\ArticleClassification\Results\Grok\key-insights-direction/{review_paper_name}.pkl"
