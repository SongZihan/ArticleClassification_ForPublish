...
with open(r"C:\Users\24033\PycharmProjects\ArticleClassification_ForPublish\Data\Summary_insight\key_dict.json", 'r',
          encoding='utf-8') as f:
    class_description = json.load(f)

for review_file in os.listdir(
        r"C:\Users\24033\PycharmProjects\ArticleClassification\Data\Abstract\AbstractData"):
