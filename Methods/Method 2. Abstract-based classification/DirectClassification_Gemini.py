...
def GPT4oPromptGenerate(system_prompt, user_prompt):
    completion = client.chat.completions.create(model="google/gemini-2.5-flash-preview-05-20", messages=[
...
for review_file in os.listdir(r"C:\Users\Administrator\PythonProjects\ArticleClassification\Data\Abstract\AbstractData"):
    ...
    # 存储结果
    output_file = fr"C:\Users\Administrator\PythonProjects\ArticleClassification\Results\Gemini\DirectClassification/{review_file.split('.')[0]}.pkl"
